    ...
    <>
      ...
      <main className="admin-page">
        ...
        <p className="admin-muted admin-hint">
          ...
          {tab === 'quotes' && 'You enter the design price per asset. Perpetual = one-time design + 50%. Annual = first year at the design price, then 1/3 of design per year. Footnote tokens: {design} {perpetual} {firstYear} (annual first year) {annual} (annual per-year price) {creditMax} (max annual-fee credit toward perpetual, 2/3 of perpetual). Changes go live on Save.'}
        </p>
      </main>
    </>
  )
